 ...
 */
export const MOTIFS = [
  {name: 'application', ground: 'violet', draw: application, topics: ['application', 'resume', 'cv', 'applicant', 'candidate']},
  {name: 'volume', ground: 'brass', draw: volume, topics: ['volume', 'scale', 'backlog', 'throughput', 'pile']},
  {name: 'role', ground: 'deep', draw: role, topics: ['role', 'job description', 'jd', 'requirements', 'brief']},
  {name: 'sourcing', ground: 'lilac', draw: sourcing, topics: ['sourcing', 'pipeline', 'inbound', 'job board']},
  {name: 'talent-pool', ground: 'violet', draw: talentPool, topics: ['talent pool', 'database', 'ats', 'archive']},
  {name: 'screening', ground: 'brass', draw: screening, topics: ['screening', 'funnel', 'filter', 'sifting']},
  {name: 'verification', ground: 'deep', draw: verification, topics: ['verification', 'claims', 'evidence', 'bgv', 'background']},
  {name: 'rubric', ground: 'lilac', draw: rubric, topics: ['rubric', 'criteria', 'scorecard', 'structured']},
  {name: 'shortlist', ground: 'violet', draw: shortlist, topics: ['shortlist', 'ranking', 'ranked', 'signals']},
  ...
  {name: 'compensation', ground: 'brass', draw: compensation, topics: ['compensation', 'salary', 'cost', 'budget', 'pricing']},
  {name: 'judgment', ground: 'deep', draw: judgment, topics: ['judgment', 'decision', 'hiring', 'people']},
  {name: 'offer', ground: 'lilac', draw: offer, topics: ['offer', 'accepted', 'closing', 'hired']},
  {name: 'declined', ground: 'violet', draw: declined, topics: ['rejection', 'declined', 'dropout', 'ghosting']},
  {name: 'onboarding', ground: 'brass', draw: onboarding, topics: ['onboarding', 'first day', 'induction', 'new hire']},
  {name: 'referral', ground: 'deep', draw: referral, topics: ['referral', 'network', 'recommendation']},
  {name: 'privacy', ground: 'lilac', draw: privacy, topics: ['privacy', 'security', 'data', 'consent', 'transparency']},
  ...
  {name: 'bots', ground: 'lilac', draw: bots, topics: ['ai', 'bots', 'cheating', 'integrity', 'llm', 'machines']},
